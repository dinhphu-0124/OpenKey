# OpenKey for Windows
[![GitHub release](https://img.shields.io/github/v/release/dinhphu-0124/OpenKey.svg)](https://github.com/dinhphu-0124/OpenKey/releases/latest)
...
## Cài đặt
- Vào [đây](https://github.com/dinhphu-0124/OpenKey/releases/latest) tải file `.zip` phiên bản mới nhất về máy, giải nén vào nơi bất kỳ.
...
## Thông tin
- Dự án OpenKey ra đời vào ngày 18/01/2019. Mục đích ra đời của OpenKey là để khắc phục lỗi gạch chân khó chịu do cơ chế `preedit` gây ra trên hệ điều hành macOS
