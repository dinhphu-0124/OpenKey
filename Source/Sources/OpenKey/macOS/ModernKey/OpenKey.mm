...
extern "C" {
    ...
    void RequestNewSession() {
        ...
        //clicking into a field starts a fresh typing context, so treat the
        //next character as the start of a new sentence (fixes the case
        //where the very first letter typed in an empty field isn't capitalized)
