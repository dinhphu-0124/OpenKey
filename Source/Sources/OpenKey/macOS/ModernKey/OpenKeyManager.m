...
+(void)checkNewVersion:(NSWindow*)parent callbackFunc:(CheckNewVersionCallback) callback {
    ...
    [[aSession dataTaskWithURL:[NSURL URLWithString:@"https://raw.githubusercontent.com/dinhphu-0124/OpenKey/main/Source/version.json"] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
